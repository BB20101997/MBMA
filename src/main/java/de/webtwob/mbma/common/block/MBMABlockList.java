...
public class MBMABlockList {
    ...
    public static final RecipeBank RECIPE_BANK_BLOCK = new RecipeBank();
    ...
    public static void registerBlocks(RegistryEvent.Register<Block> event) {
        ...
        RECIPE_BANK_BLOCK.setRegistryName(MBMAResources.RECIPE_BANK_REGISTRY_NAME);
        ...
        RECIPE_BANK_BLOCK.setUnlocalizedName(MBMAResources.RECIPE_BANK_REGISTRY_NAME.toString());

        IForgeRegistry<Block> registry = event.getRegistry();

        //register blocks
        registry.registerAll(STORAGE_INTERFACE_BLOCK, QUEUE_STACK_BLOCK,TOKEN_GENERATOR_BLOCK,RECIPE_BANK_BLOCK);
    }
}
