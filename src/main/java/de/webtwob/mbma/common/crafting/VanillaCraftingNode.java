 ...
 */
public class VanillaCraftingNode extends CraftingNode {
    /**
     ...
     * @param icnip
     */
    public VanillaCraftingNode(@Nullable CraftingNode parent, @Nonnull CraftingTree tree, @Nonnull ICraftingRequest request, @Nonnull ICraftingAccessor icnip, ICraftingRecipe recipe) {
