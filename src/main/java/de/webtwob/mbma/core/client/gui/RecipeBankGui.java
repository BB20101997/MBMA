...
public class RecipeBankGui extends GuiContainer {
    ...
    private TileEntityRecipeStoreOld te;
    private int pageScrollOffset = 0;
    private GuiButton[] pages = new GuiButton[5];

    public RecipeBankGui(EntityPlayer player, TileEntityRecipeStoreOld tileEntity) {
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY) {
        ...
        //mc.getTextureManager().bindTexture(MBMAResourceLocations.RECIPE_BANK_GUI);
