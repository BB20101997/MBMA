...
public class Blocks {
    ...
    public static final BlockRequestGenerator TOKEN_GENERATOR = new BlockRequestGenerator(TOKEN_GENERATOR_REGISTRY_NAME);
    ...
    public static final BlockCraftingController CRAFTING_CONTROLLER = new BlockCraftingController(CRAFTING_CONTROLLER_RL);
