...
public class DefaultRecipes {
    ...
    private static final String[][]                                 CRAFTING_STORAGE_PATTERN = {
            {"BBB", "BBB", "BBB"}, {"BCB", "BWB", "BCB"}, {"BBB", "BBB", "BBB"}
    };
    private static final String[][]                                 CRAFTING_PROCESSOR_PATTERN = {
            {"BBB", "BBB", "BBB"}, {"BAB", "BFB", "BWB"}, {"BBB", "BBB", "BBB"}
    };
    ...
    static {
        RECIPE_PREDICATES.put(
                'A', (Predicate<BlockWorldState>) MMAFilter.areBlocksEqual(net.minecraft.init.Blocks.ANVIL));
        RECIPE_PREDICATES.put(
                'B', (Predicate<BlockWorldState>) MMAFilter.areBlocksEqual(net.minecraft.init.Blocks.IRON_BARS));
        RECIPE_PREDICATES.put(
                'C', (Predicate<BlockWorldState>) MMAFilter.areBlocksEqual(net.minecraft.init.Blocks.CHEST));
        RECIPE_PREDICATES.put(
                'F', (Predicate<BlockWorldState>) MMAFilter.areBlocksEqual(net.minecraft.init.Blocks.FURNACE));
        RECIPE_PREDICATES.put(
                'W', (Predicate<BlockWorldState>) MMAFilter.areBlocksEqual(net.minecraft.init.Blocks.CRAFTING_TABLE));
